        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">Todos Pedidos</li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 text-light mb-0">Todos pedidos</h1>
        </div>
      </div>
    </div>
<?php
      ...
      <div class="card border-0 box-shadow-lg">
        <div class="card-body pb-2">
          <ul class="nav nav-tabs media-tabs nav-justified">
            ...
            <?php 
            if(edituser($pe->usuario)){
              $infousu = edituser($pe->usuario)
            ?>
            <li class="nav-item">
              <div class="nav-link <?php if($pe->status2 === '1'){echo 'completed';} ?>">
                <div class="media align-items-center">
                  <div class="media-tab-media mr-3">
                  <?php if($infousu->img === 'semfoto.png'){ ?>
                  <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-top: 15px;">
                  <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                  </svg>
                  <?php
                  } else {
                  ?>
                  <img width="2em" height="2em" src="img/usuarios/<?php echo $infousu->img; ?>">
                  <?php
                  }
                  ?>
                  </div>
                  <div class="media-body">
                    <div class="media-tab-subtitle text-muted font-size-xs mb-1">Cliente:</div>

                    <h6 class="media-tab-title text-nowrap mb-0"><?php echo $infousu->usuario; ?></h6>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li class="nav-item">
              <div class="nav-link">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="media-tab-subtitle text-muted font-size-xs mb-1">Cupom:</div>
                    <h6 class="media-tab-title text-nowrap mb-0"><?php echo $pe->cupom."%"; ?></h6>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li class="nav-item">
              <div class="nav-link">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="media-tab-subtitle text-muted font-size-xs mb-1">Produtos:</div>
                    <h6 class="media-tab-title text-nowrap mb-0">R$: <?php echo $pe->valor; ?></h6>
                  </div>
                </div>
              </div>
            </li>
            <li class="nav-item">
              <div class="nav-link">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="media-tab-subtitle text-muted font-size-xs mb-1">Entrega:</div>
                    <h6 class="media-tab-title text-nowrap mb-0">R$: <?php echo $pe->entrega; ?></h6>
                  </div>
                </div>
              </div>
            </li>
            ...
            if($pe->status2 === '0'){
              if($pe->status === 'approved' || $pe->status === 'retirada'){
            ?>

            <li>
              <div style="margin-left: 30px; margin-top: 20px;">
                <button class="btn btn-primary" id="recusarpedido" style="margin-left:60px;margin-bottom: 30px;">Ver detalhes do pedido</button>
                <button class="btn btn-primary" id="recusarpedido" style="margin-right: 20px;">Recusar pedido</button>
                <button class="btn btn-primary" id="aprovarpedido">Aprovar pedido</button>
              </div>
            </li>
            <?php
              }
    ...
    <?php
      ...
      ?>
       <div class="d-sm-flex justify-content-between align-items-center my-4 pb-3">
              ...
              <br /><br />
                <h2 class="h6 mb-3 pb-1">Infelizmente não tem nenhuma venda.</h2>
              </div>
            </div>
